...
func TestApplication_RegisterError(t *testing.T) {
	a := NewApplication(AppInfo{}, nil, nil)
...
func TestApplication_DoubleRun(t *testing.T) {
	a := NewApplication(AppInfo{AppName: "test"}, nil, nil)
...
func TestApplication_NewWithNilDependencies(t *testing.T) {
	...
	a = NewApplication(AppInfo{AppName: "test"}, nil, registry)
	if a == nil {
		t.Fatal("NewApplication should not return nil with nil container")
	}

	container := NewContainer()
	a = NewApplication(AppInfo{AppName: "test"}, container, nil)
	if a == nil {
		t.Fatal("NewApplication should not return nil with nil registry")
	}
}
...
func TestApplication_WithGracefulTimeout(t *testing.T) {
	...
	a = NewApplication(AppInfo{AppName: "test"}, nil, nil, WithGracefulTimeout(customTimeout))
	appImpl = a.(*app)
