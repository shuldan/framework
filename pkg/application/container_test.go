...
func TestContainer_ResolveFactory(t *testing.T) {
	c := NewContainer()
	c.Factory("greet", func(c Container) (interface{}, error) {
...
func TestContainer_CircularDependency(t *testing.T) {
	c := NewContainer()
	c.Factory("a", func(c Container) (interface{}, error) {
		b, err := c.Resolve("b")
		if err != nil {
			return nil, err
		}
	...
	c.Factory("b", func(c Container) (interface{}, error) {
		a, err := c.Resolve("a")
		if err != nil {
			return nil, err
		}
...
func TestContainer_Has(t *testing.T) {
	...
	c.Factory("factory", func(Container) (interface{}, error) {
	...
	c.Factory("both_factory", func(Container) (interface{}, error) {
		return "factory_value", nil
	})
	if !c.Has("both") {
...
func TestContainer_DuplicateFactory(t *testing.T) {
	...
	err := c.Factory("test", func(Container) (interface{}, error) {
		return "factory1", nil
	})
	if err != nil {
...
func TestContainer_FactoryErrorPropagation(t *testing.T) {
	...
	c.Factory("error_factory", func(Container) (interface{}, error) {
		return nil, testErr
	})
...
func TestContainer_ConcurrentAccess(t *testing.T) {
	...
	c.Factory("counter", func(Container) (interface{}, error) {
		return 1, nil
	})
