...
func (h *HelpCommand) Validate(ctx Context) error {
	return nil
}
...
func (h *HelpCommand) showGeneralHelp(ctx Context) error {
...
func (h *HelpCommand) showCommandHelp(ctx Context, commandName string) error {
