...
var (
	...
	ErrConfigNotFound            = ErrCodeGen().New("config not found")
	ErrInvalidConfigInstance     = ErrCodeGen().New("invalid config")
	ErrCliNotFound               = ErrCodeGen().New("cli not found")
	ErrInvalidCliInstance        = ErrCodeGen().New("invalid cli instance")
	ErrHTTPServerNotFound        = ErrCodeGen().New("http server not found")
	ErrInvalidHTTPServerInstance = ErrCodeGen().New("invalid http server instance")
	ErrFailedRegisterRoutes      = ErrCodeGen().New("failed register routes")
)
